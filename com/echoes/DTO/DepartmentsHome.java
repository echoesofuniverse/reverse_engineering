 ...
 * @see com.echoes.DTO.Departments
...
public class DepartmentsHome {
	...
	public Departments findById(java.lang.String id) {
		...
		try {
			Departments instance = (Departments) sessionFactory.getCurrentSession().get("com.echoes.DTO.Departments",
					id);
			if (instance == null) {
	...
	public List findByExample(Departments instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Departments")
