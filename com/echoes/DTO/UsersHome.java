...
public class UsersHome {
	...
	public Users findById(java.lang.Long id) {
		...
		try {
			Users instance = (Users) sessionFactory.getCurrentSession().get("com.echoes.DTO.Users", id);
			if (instance == null) {
	...
	public List findByExample(Users instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Users")
