...
public class ClassroomHome {
	...
	public Classroom merge(Classroom detachedInstance) {
		...
		try {
			Classroom result = (Classroom) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Classroom findById(int id) {
		...
		try {
			Classroom instance = (Classroom) sessionFactory.getCurrentSession().get("com.echoes.DTO.Classroom", id);
			if (instance == null) {
	...
	public List findByExample(Classroom instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Classroom")
