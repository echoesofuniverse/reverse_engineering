 ...
 * @see com.echoes.DTO.X.hostSummaryByStages
 * @author Hibernate Tools
 */
public class hostSummaryByStagesHome {

    private static final Log log = LogFactory.getLog(X.hostSummaryByStagesHome.class);
    ...
    public hostSummaryByStages findById( com.echoes.DTO.X$hostSummaryByStagesId id) {
        ...
        try {
            hostSummaryByStages instance = (hostSummaryByStages) sessionFactory.getCurrentSession()
                    .get("com.echoes.DTO.X$hostSummaryByStages", id);
            if (instance==null) {
    ...
    public List findByExample(hostSummaryByStages instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.echoes.DTO.X$hostSummaryByStages")
