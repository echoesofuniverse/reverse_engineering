 ...
 * @see com.echoes.DTO.StatementAnalysis
 * @author Hibernate Tools
 */
public class StatementAnalysisHome {

	private static final Log log = LogFactory.getLog(StatementAnalysisHome.class);
	...
	public StatementAnalysis merge(StatementAnalysis detachedInstance) {
		...
		try {
			StatementAnalysis result = (StatementAnalysis) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public StatementAnalysis findById(com.echoes.DTO.StatementAnalysisId id) {
		...
		try {
			StatementAnalysis instance = (StatementAnalysis) sessionFactory.getCurrentSession()
					.get("com.echoes.DTO.StatementAnalysis", id);
			if (instance == null) {
	...
	public List findByExample(StatementAnalysis instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.StatementAnalysis")
