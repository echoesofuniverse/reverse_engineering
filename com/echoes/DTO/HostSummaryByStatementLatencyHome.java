 ...
 * @see com.echoes.DTO.HostSummaryByStatementLatency
 * @author Hibernate Tools
 */
public class HostSummaryByStatementLatencyHome {

	private static final Log log = LogFactory.getLog(HostSummaryByStatementLatencyHome.class);
	...
	public HostSummaryByStatementLatency findById(com.echoes.DTO.HostSummaryByStatementLatencyId id) {
		...
		try {
			HostSummaryByStatementLatency instance = (HostSummaryByStatementLatency) sessionFactory.getCurrentSession()
					.get("com.echoes.DTO.HostSummaryByStatementLatency", id);
			if (instance == null) {
	...
	public List findByExample(HostSummaryByStatementLatency instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.echoes.DTO.HostSummaryByStatementLatency").add(Example.create(instance))
					.list();
