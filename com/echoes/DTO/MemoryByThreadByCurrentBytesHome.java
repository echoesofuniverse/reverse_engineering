 ...
 * @see com.echoes.DTO.MemoryByThreadByCurrentBytes
 * @author Hibernate Tools
 */
public class MemoryByThreadByCurrentBytesHome {

	private static final Log log = LogFactory.getLog(MemoryByThreadByCurrentBytesHome.class);
	...
	public MemoryByThreadByCurrentBytes findById(com.echoes.DTO.MemoryByThreadByCurrentBytesId id) {
		...
		try {
			MemoryByThreadByCurrentBytes instance = (MemoryByThreadByCurrentBytes) sessionFactory.getCurrentSession()
					.get("com.echoes.DTO.MemoryByThreadByCurrentBytes", id);
			if (instance == null) {
	...
	public List findByExample(MemoryByThreadByCurrentBytes instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.echoes.DTO.MemoryByThreadByCurrentBytes").add(Example.create(instance)).list();
