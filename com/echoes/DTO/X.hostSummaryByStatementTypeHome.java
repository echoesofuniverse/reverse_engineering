...
import X.hostSummaryByStatementType;
 ...
 * @see com.echoes.DTO.X.hostSummaryByStatementType
 * @author Hibernate Tools
 */
public class hostSummaryByStatementTypeHome {

    private static final Log log = LogFactory.getLog(X.hostSummaryByStatementTypeHome.class);
    ...
    public hostSummaryByStatementType findById( com.echoes.DTO.X$hostSummaryByStatementTypeId id) {
        ...
        try {
            hostSummaryByStatementType instance = (hostSummaryByStatementType) sessionFactory.getCurrentSession()
                    .get("com.echoes.DTO.X$hostSummaryByStatementType", id);
            if (instance==null) {
    ...
    public List findByExample(hostSummaryByStatementType instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.echoes.DTO.X$hostSummaryByStatementType")
