...
public class SchoolHome {
	...
	public School merge(School detachedInstance) {
		...
		try {
			School result = (School) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public School findById(java.lang.Integer id) {
		...
		try {
			School instance = (School) sessionFactory.getCurrentSession().get("com.echoes.DTO.School", id);
			if (instance == null) {
	...
	public List findByExample(School instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.School")
