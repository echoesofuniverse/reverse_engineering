 ...
 * @see com.echoes.DTO.X.hostSummaryByFileIo
 * @author Hibernate Tools
 */
public class hostSummaryByFileIoHome {

    private static final Log log = LogFactory.getLog(X.hostSummaryByFileIoHome.class);
    ...
    public hostSummaryByFileIo findById( com.echoes.DTO.X$hostSummaryByFileIoId id) {
        ...
        try {
            hostSummaryByFileIo instance = (hostSummaryByFileIo) sessionFactory.getCurrentSession()
                    .get("com.echoes.DTO.X$hostSummaryByFileIo", id);
            if (instance==null) {
    ...
    public List findByExample(hostSummaryByFileIo instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.echoes.DTO.X$hostSummaryByFileIo")
