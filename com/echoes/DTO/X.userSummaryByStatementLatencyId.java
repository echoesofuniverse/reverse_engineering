...
public class X.userSummaryByStatementLatencyId  implements java.io.Serializable {
    ...
    public X.userSummaryByStatementLatencyId(String user, BigDecimal total, BigDecimal totalLatency, BigDecimal maxLatency, BigDecimal lockLatency, BigDecimal cpuLatency, BigDecimal rowsSent, BigDecimal rowsExamined, BigDecimal rowsAffected, BigDecimal fullScans) {
       this.user = user;
       this.total = total;
