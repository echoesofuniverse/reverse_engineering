 ...
 * @see com.echoes.DTO.Salaries
 * @author Hibernate Tools
 */
public class SalariesHome {

	private static final Log log = LogFactory.getLog(SalariesHome.class);
	...
	public Salaries findById(com.echoes.DTO.SalariesId id) {
		log.debug("getting Salaries instance with id: " + id);
		try {
			Salaries instance = (Salaries) sessionFactory.getCurrentSession().get("com.echoes.DTO.Salaries", id);
			if (instance == null) {
	...
	public List findByExample(Salaries instance) {
		log.debug("finding Salaries instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Salaries")
