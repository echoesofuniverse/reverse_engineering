...
public class ClassHome {
	...
	public Class merge(Class detachedInstance) {
		...
		try {
			Class result = (Class) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Class findById(int id) {
		...
		try {
			Class instance = (Class) sessionFactory.getCurrentSession().get("com.echoes.DTO.Class", id);
			if (instance == null) {
	...
	public List findByExample(Class instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Class")
