 ...
 * @see com.echoes.DTO.Markets
 * @author Hibernate Tools
 */
public class MarketsHome {

	private static final Log log = LogFactory.getLog(MarketsHome.class);
	...
	public Markets findById(java.lang.String id) {
		log.debug("getting Markets instance with id: " + id);
		try {
			Markets instance = (Markets) sessionFactory.getCurrentSession().get("com.echoes.DTO.Markets", id);
			if (instance == null) {
	...
	public List findByExample(Markets instance) {
		log.debug("finding Markets instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Markets")
