 ...
 * @see com.echoes.DTO.Transactions
...
public class TransactionsHome {
	...
	public Transactions merge(Transactions detachedInstance) {
		...
		try {
			Transactions result = (Transactions) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Transactions findById(com.echoes.DTO.TransactionsId id) {
		log.debug("getting Transactions instance with id: " + id);
		try {
			Transactions instance = (Transactions) sessionFactory.getCurrentSession().get("com.echoes.DTO.Transactions",
					id);
			if (instance == null) {
	...
	public List findByExample(Transactions instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Transactions")
