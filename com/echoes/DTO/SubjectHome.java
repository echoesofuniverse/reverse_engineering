...
public class SubjectHome {
	...
	public Subject merge(Subject detachedInstance) {
		...
		try {
			Subject result = (Subject) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Subject findById(java.lang.Integer id) {
		...
		try {
			Subject instance = (Subject) sessionFactory.getCurrentSession().get("com.echoes.DTO.Subject", id);
			if (instance == null) {
	...
	public List findByExample(Subject instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Subject")
