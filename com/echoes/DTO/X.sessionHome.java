 ...
 * @see com.echoes.DTO.X.session
 * @author Hibernate Tools
 */
public class sessionHome {

    private static final Log log = LogFactory.getLog(X.sessionHome.class);
    ...
    public List findByExample(session instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.echoes.DTO.X$session")
