 ...
 * @see com.echoes.DTO.UserSummaryByStatementType
 * @author Hibernate Tools
 */
public class UserSummaryByStatementTypeHome {

	private static final Log log = LogFactory.getLog(UserSummaryByStatementTypeHome.class);
	...
	public UserSummaryByStatementType findById(com.echoes.DTO.UserSummaryByStatementTypeId id) {
		...
		try {
			UserSummaryByStatementType instance = (UserSummaryByStatementType) sessionFactory.getCurrentSession()
					.get("com.echoes.DTO.UserSummaryByStatementType", id);
			if (instance == null) {
	...
	public List findByExample(UserSummaryByStatementType instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.echoes.DTO.UserSummaryByStatementType").add(Example.create(instance)).list();
