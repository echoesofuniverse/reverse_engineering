 ...
 * @see com.echoes.DTO.StatementsWithSorting
 * @author Hibernate Tools
 */
public class StatementsWithSortingHome {

	private static final Log log = LogFactory.getLog(StatementsWithSortingHome.class);
	...
	public StatementsWithSorting findById(com.echoes.DTO.StatementsWithSortingId id) {
		...
		try {
			StatementsWithSorting instance = (StatementsWithSorting) sessionFactory.getCurrentSession()
					.get("com.echoes.DTO.StatementsWithSorting", id);
			if (instance == null) {
	...
	public List findByExample(StatementsWithSorting instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.StatementsWithSorting")
