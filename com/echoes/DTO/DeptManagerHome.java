 ...
 * @see com.echoes.DTO.DeptManager
 * @author Hibernate Tools
 */
public class DeptManagerHome {

	private static final Log log = LogFactory.getLog(DeptManagerHome.class);
	...
	public DeptManager findById(com.echoes.DTO.DeptManagerId id) {
		log.debug("getting DeptManager instance with id: " + id);
		try {
			DeptManager instance = (DeptManager) sessionFactory.getCurrentSession().get("com.echoes.DTO.DeptManager",
					id);
			if (instance == null) {
	...
	public List findByExample(DeptManager instance) {
		log.debug("finding DeptManager instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.DeptManager")
