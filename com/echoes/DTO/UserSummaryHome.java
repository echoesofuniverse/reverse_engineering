 ...
 * @see com.echoes.DTO.UserSummary
 * @author Hibernate Tools
 */
public class UserSummaryHome {

	private static final Log log = LogFactory.getLog(UserSummaryHome.class);
	...
	public UserSummary merge(UserSummary detachedInstance) {
		...
		try {
			UserSummary result = (UserSummary) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public UserSummary findById(com.echoes.DTO.UserSummaryId id) {
		log.debug("getting UserSummary instance with id: " + id);
		try {
			UserSummary instance = (UserSummary) sessionFactory.getCurrentSession().get("com.echoes.DTO.UserSummary",
					id);
			if (instance == null) {
	...
	public List findByExample(UserSummary instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.UserSummary")
