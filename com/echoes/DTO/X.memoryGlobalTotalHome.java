 ...
 * @see com.echoes.DTO.X.memoryGlobalTotal
 * @author Hibernate Tools
 */
public class memoryGlobalTotalHome {

    private static final Log log = LogFactory.getLog(X.memoryGlobalTotalHome.class);
    ...
    public memoryGlobalTotal merge(memoryGlobalTotal detachedInstance) {
        ...
        try {
            memoryGlobalTotal result = (memoryGlobalTotal) sessionFactory.getCurrentSession()
    ...
    public memoryGlobalTotal findById( java.math.BigDecimal id) {
        ...
        try {
            memoryGlobalTotal instance = (memoryGlobalTotal) sessionFactory.getCurrentSession()
                    .get("com.echoes.DTO.X$memoryGlobalTotal", id);
            if (instance==null) {
    ...
    public List findByExample(memoryGlobalTotal instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.echoes.DTO.X$memoryGlobalTotal")
