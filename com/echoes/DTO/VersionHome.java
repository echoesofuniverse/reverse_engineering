...
public class VersionHome {
	...
	public Version merge(Version detachedInstance) {
		...
		try {
			Version result = (Version) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Version findById(com.echoes.DTO.VersionId id) {
		log.debug("getting Version instance with id: " + id);
		try {
			Version instance = (Version) sessionFactory.getCurrentSession().get("com.echoes.DTO.Version", id);
			if (instance == null) {
	...
	public List findByExample(Version instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Version")
