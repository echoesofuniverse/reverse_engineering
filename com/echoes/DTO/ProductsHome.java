...
public class ProductsHome {
	...
	public Products findById(java.lang.String id) {
		...
		try {
			Products instance = (Products) sessionFactory.getCurrentSession().get("com.echoes.DTO.Products", id);
			if (instance == null) {
	...
	public List findByExample(Products instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Products")
