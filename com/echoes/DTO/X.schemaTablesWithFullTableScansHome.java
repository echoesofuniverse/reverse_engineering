...
import X.schemaTablesWithFullTableScans;
 ...
 * @see com.echoes.DTO.X.schemaTablesWithFullTableScans
 * @author Hibernate Tools
 */
public class schemaTablesWithFullTableScansHome {

    private static final Log log = LogFactory.getLog(X.schemaTablesWithFullTableScansHome.class);
    ...
    public schemaTablesWithFullTableScans findById( com.echoes.DTO.X$schemaTablesWithFullTableScansId id) {
        log.debug("getting schemaTablesWithFullTableScans instance with id: " + id);
        try {
            schemaTablesWithFullTableScans instance = (schemaTablesWithFullTableScans) sessionFactory.getCurrentSession()
                    .get("com.echoes.DTO.X$schemaTablesWithFullTableScans", id);
            if (instance==null) {
    ...
    public List findByExample(schemaTablesWithFullTableScans instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.echoes.DTO.X$schemaTablesWithFullTableScans")
