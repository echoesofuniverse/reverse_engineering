 ...
 * @see com.echoes.DTO.X.schemaTableLockWaits
 * @author Hibernate Tools
 */
public class schemaTableLockWaitsHome {

    private static final Log log = LogFactory.getLog(X.schemaTableLockWaitsHome.class);
    ...
    public schemaTableLockWaits findById( com.echoes.DTO.X$schemaTableLockWaitsId id) {
        ...
        try {
            schemaTableLockWaits instance = (schemaTableLockWaits) sessionFactory.getCurrentSession()
                    .get("com.echoes.DTO.X$schemaTableLockWaits", id);
            if (instance==null) {
    ...
    public List findByExample(schemaTableLockWaits instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.echoes.DTO.X$schemaTableLockWaits")
