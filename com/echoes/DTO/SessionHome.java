...
public class SessionHome {
	...
	public Session merge(Session detachedInstance) {
		...
		try {
			Session result = (Session) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Session findById(com.echoes.DTO.SessionId id) {
		log.debug("getting Session instance with id: " + id);
		try {
			Session instance = (Session) sessionFactory.getCurrentSession().get("com.echoes.DTO.Session", id);
			if (instance == null) {
	...
	public List findByExample(Session instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Session")
