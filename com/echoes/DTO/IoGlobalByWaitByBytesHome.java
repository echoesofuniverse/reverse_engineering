 ...
 * @see com.echoes.DTO.IoGlobalByWaitByBytes
 * @author Hibernate Tools
 */
public class IoGlobalByWaitByBytesHome {

	private static final Log log = LogFactory.getLog(IoGlobalByWaitByBytesHome.class);
	...
	public IoGlobalByWaitByBytes findById(com.echoes.DTO.IoGlobalByWaitByBytesId id) {
		...
		try {
			IoGlobalByWaitByBytes instance = (IoGlobalByWaitByBytes) sessionFactory.getCurrentSession()
					.get("com.echoes.DTO.IoGlobalByWaitByBytes", id);
			if (instance == null) {
	...
	public List findByExample(IoGlobalByWaitByBytes instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.IoGlobalByWaitByBytes")
