 ...
 * @see com.echoes.DTO.DeptEmp
 * @author Hibernate Tools
 */
public class DeptEmpHome {

	private static final Log log = LogFactory.getLog(DeptEmpHome.class);
	...
	public DeptEmp findById(com.echoes.DTO.DeptEmpId id) {
		log.debug("getting DeptEmp instance with id: " + id);
		try {
			DeptEmp instance = (DeptEmp) sessionFactory.getCurrentSession().get("com.echoes.DTO.DeptEmp", id);
			if (instance == null) {
	...
	public List findByExample(DeptEmp instance) {
		log.debug("finding DeptEmp instance by example");
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.DeptEmp")
