...
public class RolesHome {
	...
	public Roles findById(java.lang.Integer id) {
		...
		try {
			Roles instance = (Roles) sessionFactory.getCurrentSession().get("com.echoes.DTO.Roles", id);
			if (instance == null) {
	...
	public List findByExample(Roles instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Roles")
