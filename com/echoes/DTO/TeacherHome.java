...
public class TeacherHome {
	...
	public Teacher findById(int id) {
		...
		try {
			Teacher instance = (Teacher) sessionFactory.getCurrentSession().get("com.echoes.DTO.Teacher", id);
			if (instance == null) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Teacher")
