...
public class CustomersHome {
	...
	public Customers findById(java.lang.String id) {
		...
		try {
			Customers instance = (Customers) sessionFactory.getCurrentSession().get("com.echoes.DTO.Customers", id);
			if (instance == null) {
	...
	public List findByExample(Customers instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Customers")
