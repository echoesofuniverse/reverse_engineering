...
/**
 * Home object for domain model class SysConfig.
 * @see com.echoes.DTO.SysConfig
 * @author Hibernate Tools
 */
public class SysConfigHome {

	private static final Log log = LogFactory.getLog(SysConfigHome.class);
	...
	public void persist(SysConfig transientInstance) {
		log.debug("persisting SysConfig instance");
		try {
	...
	public SysConfig merge(SysConfig detachedInstance) {
		...
		try {
			SysConfig result = (SysConfig) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public SysConfig findById(java.lang.String id) {
		...
		try {
			SysConfig instance = (SysConfig) sessionFactory.getCurrentSession().get("com.echoes.DTO.SysConfig", id);
			if (instance == null) {
	...
	public List findByExample(SysConfig instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.SysConfig")
