...
public class ParentHome {
	...
	public Parent findById(int id) {
		...
		try {
			Parent instance = (Parent) sessionFactory.getCurrentSession().get("com.echoes.DTO.Parent", id);
			if (instance == null) {
	...
	public List findByExample(Parent instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Parent")
