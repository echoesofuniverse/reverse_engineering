...
import X.statementsWithFullTableScans;
 ...
 * @see com.echoes.DTO.X.statementsWithFullTableScans
 * @author Hibernate Tools
 */
public class statementsWithFullTableScansHome {

    private static final Log log = LogFactory.getLog(X.statementsWithFullTableScansHome.class);
    ...
    public statementsWithFullTableScans findById( com.echoes.DTO.X$statementsWithFullTableScansId id) {
        ...
        try {
            statementsWithFullTableScans instance = (statementsWithFullTableScans) sessionFactory.getCurrentSession()
                    .get("com.echoes.DTO.X$statementsWithFullTableScans", id);
            if (instance==null) {
    ...
    public List findByExample(statementsWithFullTableScans instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("com.echoes.DTO.X$statementsWithFullTableScans")
