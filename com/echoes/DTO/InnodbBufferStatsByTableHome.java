 ...
 * @see com.echoes.DTO.InnodbBufferStatsByTable
 * @author Hibernate Tools
 */
public class InnodbBufferStatsByTableHome {

	private static final Log log = LogFactory.getLog(InnodbBufferStatsByTableHome.class);
	...
	public InnodbBufferStatsByTable findById(com.echoes.DTO.InnodbBufferStatsByTableId id) {
		...
		try {
			InnodbBufferStatsByTable instance = (InnodbBufferStatsByTable) sessionFactory.getCurrentSession()
					.get("com.echoes.DTO.InnodbBufferStatsByTable", id);
			if (instance == null) {
	...
	public List findByExample(InnodbBufferStatsByTable instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.InnodbBufferStatsByTable")
