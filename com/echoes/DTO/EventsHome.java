...
public class EventsHome {
	...
	public Events findById(long id) {
		...
		try {
			Events instance = (Events) sessionFactory.getCurrentSession().get("com.echoes.DTO.Events", id);
			if (instance == null) {
	...
	public List findByExample(Events instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Events")
