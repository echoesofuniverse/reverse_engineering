...
public class MetricsHome {
	...
	public Metrics merge(Metrics detachedInstance) {
		...
		try {
			Metrics result = (Metrics) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Metrics findById(com.echoes.DTO.MetricsId id) {
		log.debug("getting Metrics instance with id: " + id);
		try {
			Metrics instance = (Metrics) sessionFactory.getCurrentSession().get("com.echoes.DTO.Metrics", id);
			if (instance == null) {
	...
	public List findByExample(Metrics instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.echoes.DTO.Metrics")
